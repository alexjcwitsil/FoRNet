...
def calc_feature_stats(vals, xy_inds, img_shape):
    ...
    ##stat_names = ["mean", "sd", "skew", "kurt","median", "25_perc", "50_perc", "75_perc", "max_freq_dist"]
    ...
    ##stats_list = [val_mean, val_sd, val_skew, val_kurt, val_median, val_25perc, val_50perc, val_75perc, max_ind_dist]
